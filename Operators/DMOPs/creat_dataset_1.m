...
function [RT,DSFR,PIPEFR,FPORDER,c1,c2,TKS,FP] = parameter_setting()
	...
	Total = [41992       49008      120000       30000       38000       21000];
	FP = Total - EOP;               %进料包(可计算原油种类)
end

%% 初始化
function [ET,UD,PET,DSFET,FP,TKS,scheduleplan,DSFR,PIPEFR,FPORDER,RT] = init()
    [RT,DSFR,PIPEFR,FPORDER,~,~,TKS,FP] = parameter_setting();
